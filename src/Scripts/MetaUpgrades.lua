...
modutil.mod.Path.Wrap("BiomeSpeedTimerLoop", function(base)
	...
	if game.CurrentRun.BiomeTime <= 0 and config.disableTimerOutOfCombat and game.BiomeTimeLimits.Penalty.Interval == game.BiomeTimeLimits.Penalty.ModVowOfMoreOrLessTimePausedTimerInterval then
